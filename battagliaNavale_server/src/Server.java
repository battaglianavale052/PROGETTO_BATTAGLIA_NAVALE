...
public class Server {
    ...
    public void spara(BufferedReader reader1, PrintWriter writer1, BufferedReader reader2,
        ...
        if(giocatoreCorrente==giocatore1)
        {
            //presumendo che il client invia "riga;colonna" del colpo
            System.out.println("ricezione colpo 1...");
            String messaggio1 = reader1.readLine();
            String[] parti = messaggio1.split(";");
             System.out.println("ricevuto 2: " + messaggio1);
            int rigaColpo = Integer.parseInt(parti[0]);
            int colonnaColpo = Integer.parseInt(parti[1]);

            //esegue la funzione per sparare un colpo e invia il suo esito ad entrambi i client
            //la funzione invia il messaggio "esito_sparo;rigaSparo;colonnaSparo"
            writer1.println(giocatore1.effettuaSparo(rigaColpo, colonnaColpo));
            writer2.println(giocatore1.effettuaSparo(rigaColpo, colonnaColpo));

        }
        else if(giocatoreCorrente==giocatore2)
        {
            //presumendo che il client invia "riga;colonna" del colpo
            System.out.println("ricezione colpo 2...");
            String messaggio2 = reader2.readLine();
            String[] parti = messaggio2.split(";");
             System.out.println("ricevuto 2: " + messaggio2);
            int rigaColpo = Integer.parseInt(parti[0]);
            int colonnaColpo = Integer.parseInt(parti[1]);
            ...
            //esegue la funzione per sparare un colpo e invia il suo esito ad entrambi i client
            //la funzione invia il messaggio "esito_sparo;rigaSparo;colonnaSparo"
            writer1.println(giocatore2.effettuaSparo(rigaColpo, colonnaColpo));
            writer2.println(giocatore2.effettuaSparo(rigaColpo, colonnaColpo));
        }
    }
